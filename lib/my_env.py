...
cols = ['clientip', 'duration', 'protocol', 'urlpath', 'urlquery', 'bytes', 'timestamp',
        'auth', 'user', 'uid', 'useragent', 'vhost', 'vhostip']

urlpath_starters = {"/api/vindeenjob/vacatures": "vindeenjobopl",
                    ...
                    "/opleidingen/aanbod": "opleidingaanbod"}
